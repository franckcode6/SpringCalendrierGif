...
public class CalendrierGifController {
	...
	//Toutes les méthodes de ce controllers devront renvoyer un objet de type ModelAndView
	//Métaphore de la danette Pop :)
	//On indique sur quelles URLs la méthode va écouter
	//Autrement dit sur quelle(s) sont la ou les URL(s) que la méthode prend en charge
	...
	public ModelAndView acceuil() {
		...
		//Equivalent de request.setAttribute("nbInscrits, utilisateurService.recupererNbInscrits()")
